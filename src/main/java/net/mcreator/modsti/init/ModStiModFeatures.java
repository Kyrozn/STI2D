...
import net.mcreator.modsti.world.features.ores.CharbonchaudFeature;
...
public class ModStiModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(CharbonchaudFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				CharbonchaudFeature.GENERATE_BIOMES, CharbonchaudFeature.CONFIGURED_FEATURE));
	}
