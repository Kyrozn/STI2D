...
public abstract class TestArmorItem extends ArmorItem {
	...
	public static class Helmet extends TestArmorItem {
		public Helmet() {
			...
			setRegistryName("test_armor_helmet");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mod_sti:textures/models/armor/test_layer_1.png";
		}
	}
	...
	public static class Chestplate extends TestArmorItem {
		public Chestplate() {
			...
			setRegistryName("test_armor_chestplate");
		}
	...
	public static class Leggings extends TestArmorItem {
		public Leggings() {
			...
			setRegistryName("test_armor_leggings");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "mod_sti:textures/models/armor/test_layer_2.png";
		}
	}
	...
	public static class Boots extends TestArmorItem {
		public Boots() {
			...
			setRegistryName("test_armor_boots");
		}
