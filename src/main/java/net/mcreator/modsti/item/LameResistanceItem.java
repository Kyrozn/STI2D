...
public class LameResistanceItem extends SwordItem {
	public LameResistanceItem() {
		super(new Tier() {
			public int getUses() {
				return 1000;
			}
		...
		setRegistryName("lame_resistance");
	}

	@Override
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		super.appendHoverText(itemstack, world, list, flag);
		list.add(new TextComponent("Donne un effet de R\u00E9sistance quand elle est dans l'inventaire"));
	}
